...
BUILD_APP=$(NES_EMU)/abstract_file.o $(NES_EMU)/apu_state.o $(NES_EMU)/Blip_Buffer.o \
	$(NES_EMU)/Effects_Buffer.o $(NES_EMU)/Mapper_Fme7.o $(NES_EMU)/Mapper_Mmc5.o \
	$(NES_EMU)/Mapper_Namco106.o $(NES_EMU)/Mapper_Vrc6.o $(NES_EMU)/misc_mappers.o \
...
CFLAGS  = -Wall -specs=psp2.specs -I$(NES_EMU) -I$(FEX) -I$(SOURCES)
